	...
	<div class="grid items-center gap-10 md:grid-cols-2">
		<div class="flex flex-col gap-4">
			...
			<p class="max-w-prose text-chalk/70">
				Everything you tell YBT lands in one knowledge base for your business. Ask it a
				question in plain English and it answers from your own rules, your own jobs, your own
		...
		<div class="flex flex-col gap-3 rounded-2xl border border-hairline bg-carriage p-8">
			...
			<ul class="flex flex-col gap-3">
				<li class="flex items-center gap-3 text-sm text-chalk/80">
					...
					Answers questions from your own records, on demand
				</li>
				<li class="flex items-center gap-3 text-sm text-chalk/80">
					<span class="h-2 w-2 shrink-0 rounded-full bg-go"></span>
					Reads the documents you drop in and keeps itself current
				</li>
				<li class="flex items-center gap-3 text-sm text-chalk/80">
					<span class="h-2 w-2 shrink-0 rounded-full bg-caution"></span>
					Interviews you about the gaps it finds in its own picture
				</li>
				<li class="flex items-center gap-3 text-sm text-chalk/80">
